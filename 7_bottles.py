...
def cal(n, r1, r2, r3):
    ...
    for i in range(plastic_b_count + 1):
        remaining = n - (i * r1)
        glass_b_count = remaining // 2  # check how many glass bottles we can buy
        remaining = (
            remaining % r2
        ...
        if glass_b_count != 0:
            ...
            if remaining < r1 and remaining < r2:
                return (
                    i + glass_b_count
                )  # return if we have less amount --> total bottles --> where i is plastic
                # bottles
